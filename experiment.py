...
def do():
    ...
    print("a")
    measure2(knots, 13, 40, 'B')
    print("b")
    measure2(knots, 13, 30, 'R')
    print("c")

    measure2(alt, 13, 50, 'A')
    print("a")
    measure2(alt, 13, 40, 'B')
    print("b")
    measure2(alt, 13, 30, 'R')
    print("c")

    measure2(links, 13, 50, 'A')
    print("a")
    measure2(links, 13, 40, 'B')
    print("b")
    measure2(links, 13, 30, 'R')
    print("c")
