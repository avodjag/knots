...
# pro vypocet Jonesova polynomu viz fce jones() dole
...
def bracket(prev_knot, reid2, looped):
    ...
    if(var == 'A'):
        ...
        edge = random.choice(list(knot.keys())) #var RND
...
# fce na vypocet Jonesova polynomu
# in: link v PD notaci zapsany jako list of lists
# jonesuv polynom, string
