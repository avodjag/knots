...
Možné stěny s dvěma a třemi hranami jsou zobrazené na obrázku ????.
...
\subsection{Výsledný algoritmus výpočtu závorkového polynomu}
...
Na obrázku ??  je znázorněn možný průběh algoritmu na tomto diagramu takový, že jsou postupně odpojovány krajní kružnice. 
